...
if($query > 0){
	...
	$queryInsert = mysql_query('update tbpessoas set tbpessoastipo ='.$tipo.', tbpessoasnome="'.$nome.'", tbpessoasnacimento="'.$nome.'",tbpessoascpfcnpj ="'.$cpf.'", tbpessoastel1 ="'.$tel1.'", tbpessoastel2 ="'.$tel2.'", tbpessoasemail1 ="'.$email1.'", tbpessoasemail2 ="'.$email2.'", tbpessoasendereco ="'.$endereco.'", tbpessoascep ="'.$cep.'" where idtbpessoas = '.$id.';');
