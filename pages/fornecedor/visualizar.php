...
include("../cabecalho.php");
 ...
 $query ="SELECT * FROM tbpessoas where tbpessoastipo = 2 and tbpessoasst > 0";  
...
?>     
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
            	<div class="col-lg-12">
            		<a href="../fornecedor/cadastrar.php" class="btn btn-primary">Cadastrar</a>
                    <br /><br />
                </div>
            </div>
            <!-- /.row -->
										   ...
										   <tr>  
												...
												<td width="5%">
													<a href="detalhes.php?id='.$id.'">
														...
														data-toggle="tooltip" data-placement="top" title="Visualizar Fornecedor">
												...
												<td width="5%">
													<a href="editar.php?id='.$id.'">
														...
														data-toggle="tooltip" data-placement="top" title="Editar Fornecedor">
												...
												<td width="5%">
													<a href="excluir.php?id='.$id.'">
														...
														data-toggle="tooltip" data-placement="top" title="Excluir Fornecedor">
